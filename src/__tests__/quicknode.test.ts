...
describe("QuickNodeIntegration", () => {
  ...
  describe("callRpcMethod", () => {
    ...
    it("should handle network errors", async () => {
      ...
      await expect(quicknode.callRpcMethod("getSlot", [])).rejects.toThrow(
        "Network timeout",
      );
    });
    ...
    it("should handle axios errors with response", async () => {
      ...
      await expect(
        quicknode.callRpcMethod("getSlot", []),
      ).rejects.toBeDefined();
    });
  ...
  describe("invokeFunction", () => {
    ...
    it("should handle function invocation errors", async () => {
      ...
      await expect(
        quicknode.invokeFunction("testFunction", {}),
      ).rejects.toBeDefined();
    });
  ...
  describe("getTokenPrice", () => {
    it("should fetch token price successfully", async () => {
      ...
      const price = await quicknode.getTokenPrice(
  ...
  describe("getCachedArbitrageOpportunity", () => {
    ...
    it("should return null when cache miss", async () => {
      ...
      const result =
        await quicknode.getCachedArbitrageOpportunity("nonexistent");
