...
describe('WalletScoring', () => {
  ...
  describe('analyzeWallet', () => {
    ...
    it('should analyze wallet with all scoring factors', async () => {
      ...
      mockConnection.getParsedTokenAccountsByOwner.mockResolvedValue(mockTokenAccounts as any);
    ...
    it('should handle connection errors gracefully', async () => {
      ...
      mockConnection.getParsedTokenAccountsByOwner.mockResolvedValue({ value: [] } as any);
