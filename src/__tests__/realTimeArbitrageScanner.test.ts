...
describe("RealTimeArbitrageScanner", () => {
  ...
  beforeEach(() => {
    ...
    mockJupiter = (
      JupiterV6Integration as jest.MockedClass<typeof JupiterV6Integration>
    ).mock.instances[0] as jest.Mocked<JupiterV6Integration>;
  });
