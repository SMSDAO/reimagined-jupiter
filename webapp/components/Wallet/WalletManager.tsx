...
export default function WalletManager() {
  ...
  const handleDeleteWallet = () => {
    if (
      confirm(
        "⚠️ Are you sure you want to delete your stored wallet? This cannot be undone!",
      )
    ) {
      deleteEncryptedWallet();
    ...
    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/10">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-400 mt-1">
                    ⚠️ Save this securely! It will be encrypted with your
                    password.
                  </p>
                </div>
                <div>
      ...
      <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
        <p className="text-xs text-yellow-400">
          🔒 <strong>Security Notes:</strong> All wallets are encrypted with
          AES-256-GCM before storage. Your password never leaves your browser.
