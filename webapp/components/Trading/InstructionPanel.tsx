    ...
    steps: [
      {
        ...
        description:
          'Click "Connect Wallet" button and select your Solana wallet',
        icon: "🔗",
      },
      {
        title: "Configure Settings",
        description:
          "Set your minimum profit threshold and slippage tolerance. Enable auto-execute if you want trades to run automatically.",
        icon: "⚙️",
      },
      {
        title: "Set Gas Priority",
        description:
          "Choose priority fee level: Low (slow), Medium (normal), High (fast), or Critical (instant)",
        icon: "⛽",
      },
      {
        title: "Start Scanning",
        description:
          'Click "Start Bot" to begin scanning for arbitrage opportunities across 5+ flash loan providers and 8+ DEXs',
        icon: "🔍",
      },
      {
        title: "Execute Trades",
        description:
          'When opportunities appear, click "Execute" or let auto-execute handle it. The bot uses Jito bundles for MEV protection.',
        icon: "⚡",
      },
    ],
    tips: [
  ...
  swap: {
    ...
    steps: [
      ...
      },
      {
        title: "Enter Amount",
        description:
          "Input the amount you want to swap. Output amount updates automatically",
        icon: "💰",
      },
      {
        title: "Set Slippage",
        description:
          "Choose slippage tolerance (0.1%, 0.5%, 1%, 5%) or set a custom value",
        icon: "📊",
      },
      {
        title: "Review & Swap",
        description:
          'Check the price impact and route, then click "Swap" to execute via Jupiter aggregator',
        icon: "✅",
      },
    ],
    tips: [
  ...
  sniper: {
    ...
    steps: [
      ...
      },
      {
        title: "Configure Bot",
        description:
          "Set buy amount (in SOL) and slippage tolerance. Higher slippage recommended for new launches.",
        icon: "⚙️",
      },
      {
        title: "Enable Auto-Snipe",
        description:
          "Toggle auto-snipe to automatically buy when new tokens are detected",
        icon: "🤖",
      },
      {
        title: "Start Monitoring",
        description:
          'Click "Start Bot" to monitor Pump.fun, Raydium, Orca, and other platforms for new token launches',
        icon: "👀",
      },
      {
        title: "Snipe Targets",
        description:
          'When targets appear, click "SNIPE NOW" or let auto-snipe handle it with high-priority transactions',
        icon: "🎯",
      },
    ],
    tips: [
    ...
    steps: [
      {
        title: "Connect Wallet",
        description:
          "Connect your wallet to deploy tokens and participate in airdrops",
        icon: "🔗",
      },
      {
      ...
      },
      {
        ...
        description:
          "Choose what percentage of supply to allocate to the roulette game (1-50%)",
        icon: "🎰",
      },
      {
        title: "Deploy Token",
        description:
          'Review deployment cost (0.01 SOL) and click "Deploy Token"',
        icon: "🚀",
      },
      {
        title: "Play Roulette",
        description:
          "After deployment, use the airdrop spin game to distribute tokens (12hr cooldown between spins)",
        icon: "🎲",
      },
    ],
    tips: [
  ...
  staking: {
    ...
    steps: [
      ...
      },
      {
        title: "Select Pool",
        description:
          "Choose a staking pool from Marinade, Lido, Jito, BlazeStake, or Kamino based on APY and TVL",
        icon: "🏊",
      },
      {
        title: "Enter Amount",
        description:
          "Input the amount of SOL you want to stake (minimum varies by pool)",
        icon: "💰",
      },
      {
        title: "Review Returns",
        description:
          "Check estimated returns based on current APY rates. Rates update in real-time.",
        icon: "📊",
      },
      {
        title: "Stake Now",
        description:
          'Click "Stake Now" to execute. Receive liquid staking tokens (mSOL, stSOL, etc.) immediately',
        icon: "✅",
      },
    ],
    tips: [
  ...
  airdrop: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "System analyzes your on-chain activity: transactions, NFTs, balance, and trading history",
        icon: "🔍",
      },
      {
        title: "Social Intelligence",
        description:
          "If linked, checks Farcaster profile for follower count, casts, power badge, and GM score",
        icon: "🟦",
      },
      {
        title: "Trust Score",
        description:
          "Calculates overall trust score (0-100) combining on-chain metrics and social factors",
        icon: "🛡️",
      },
      {
        title: "Claim Airdrops",
        description:
          'View claimable airdrops and claim individually or use "Claim All" for eligible drops',
        icon: "💰",
      },
    ],
    tips: [
...
export default function InstructionPanel({
  ...
  return (
    <div
      className={`bg-white/10 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden ${className}`}
    >
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-gray-300 text-xs">
                  All transactions are signed locally using Solana Wallet
                  Adapter. Your private keys{" "}
