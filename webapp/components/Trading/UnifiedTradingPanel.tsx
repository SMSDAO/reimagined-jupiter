  ...
  const handleSettingChange = (updates: Partial<TradingSettings>) => {
    ...
    if ("autoExecute" in updates || "slippage" in updates) {
      const updatedUserSettings = {
        ...userSettings,
        ...(updates.autoExecute !== undefined && {
          autoExecute: updates.autoExecute,
        }),
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center justify-between bg-white/5 rounded-lg p-3">
            ...
            <button
              onClick={() =>
                handleSettingChange({ autoExecute: !settings.autoExecute })
              }
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            {(
              Object.keys(priorityFeeInfo) as Array<
                keyof typeof priorityFeeInfo
              >
            ).map((level) => (
              <motion.button
                key={level}
              ...
              >
                <div className="font-semibold capitalize">
                  {priorityFeeInfo[level].label}
                </div>
                <div className="text-xs opacity-75">
                  {priorityFeeInfo[level].fee}
                </div>
              </motion.button>
            ))}
          </div>
          ...
          <div className="space-y-2">
            <input
              ...
              value={
                settings.priorityFeeLamports ||
                priorityFeePresets[settings.priorityFee]
              }
              onChange={(e) => {
          ...
          <p className="text-gray-400 text-xs mt-2">
            Higher priority = faster confirmation but higher fees (max 10M
            lamports)
          </p>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {(
              Object.keys(executionSpeedInfo) as Array<
                keyof typeof executionSpeedInfo
              >
            ).map((speed) => (
              <motion.button
                key={speed}
              ...
              >
                <div className="font-semibold">
                  {executionSpeedInfo[speed].label}
                </div>
                <div className="text-xs opacity-75">
                  {executionSpeedInfo[speed].description}
                </div>
              </motion.button>
            ))}
          </div>
        ...
        {settings.executionSpeed === "mev-protected" && (
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                handleSettingChange({ jitoTip: parseInt(e.target.value) })
              }
              className="w-full h-2 bg-white/20 rounded-lg appearance-none cursor-pointer slider"
              style={{
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange({ customRpcUrl: e.target.value })
                    }
                    placeholder="https://..."
                ...
                <div className="pt-2 border-t border-white/10">
                  <div className="text-xs text-gray-400">
                    ℹ️ Advanced settings are for experienced users. Incorrect
                    values may cause transaction failures.
                  </div>
                </div>
              </motion.div>
            )}
        ...
        <div className="bg-white/5 rounded-lg p-3 border border-white/10 space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-blue-400 font-semibold">
              {(settings.priorityFeeLamports ||
                priorityFeePresets[settings.priorityFee]) / 1e9}{" "}
              SOL
            </span>
          </div>
        </div>
