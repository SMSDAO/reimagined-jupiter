  ...
  const checkAirdrops = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/wallet-analysis/${publicKey.toString()}`,
      );
      ...
      if (analysis.farcaster_fid) {
        score.socialIntelligence = {
          ...
          gmScore: {
            ...
            averageLikes:
              analysis.gm_total_likes / Math.max(analysis.gm_casts_count, 1) ||
              0,
            averageRecasts:
              analysis.gm_total_recasts /
                Math.max(analysis.gm_casts_count, 1) || 0,
      ...
      const airdropResponse = await fetch(
        `/api/airdrops/check/${publicKey.toString()}`,
      );
            ...
            <div className="lg:col-span-2">
              <div className="glass-morphism rounded-xl p-12 text-center">
                ...
                <p className="text-gray-300">
                  Connect your wallet to access advanced wallet analysis with
                  social intelligence
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="glass-morphism rounded-xl p-12 text-center">
                ...
                <p className="text-gray-400 mt-2">
                  Fetching on-chain data and social intelligence
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="trust-orb">
                          <div className="text-center relative z-10">
                            <div className="text-4xl font-bold text-white">
                              {walletScore.socialIntelligence?.trustScore
                                .totalScore || walletScore.totalScore}
                            </div>
                      ...
                      <div className="text-center">
                        <div
                          className={`inline-block px-8 py-4 rounded-full bg-gradient-to-r ${getTierColor(walletScore.tier)} text-white font-bold text-3xl mb-4`}
                        >
                          {walletScore.tier}
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white font-bold">
                            {walletScore.balance.toFixed(2)} SOL
                          </span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div className="social-card farcaster-card glass-morphism rounded-xl p-6 neon-pulse-blue">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {walletScore.socialIntelligence.farcasterScore.profile
                          ?.powerBadge && <span className="text-2xl">⚡</span>}
                      </div>

                      <div className="text-5xl font-bold text-white mb-6">
                        {
                          walletScore.socialIntelligence.farcasterScore
                            .totalScore
                        }
                        /100
                      </div>
                      ...
                      {walletScore.socialIntelligence.farcasterScore
                        ...
                        <div className="mb-6 pb-6 border-b border-white/10">
                          ...
                          <div className="text-sm text-gray-300">
                            {walletScore.socialIntelligence.farcasterScore.profile.followerCount.toLocaleString()}{" "}
                            followers
                          </div>
                        </div>
                      )}
                    ...
                    <div className="social-card gm-card glass-morphism rounded-xl p-6 neon-pulse-green">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xl font-bold text-[#00ff9d]">
                            {walletScore.socialIntelligence.gmScore.averageLikes.toFixed(
                              1,
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xl font-bold text-[#00ff9d]">
                            {walletScore.socialIntelligence.gmScore.averageRecasts.toFixed(
                              1,
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xl font-bold text-[#00ff9d]">
                            {walletScore.socialIntelligence.gmScore.consistency}{" "}
                            days
                          </span>
                        </div>
                        <div className="pt-4 border-t border-white/10">
                          ...
                          <div className="w-full bg-white/10 rounded-full h-3">
                            <div
                              ...
                              style={{
                                width: `${walletScore.socialIntelligence.gmScore.communityEngagement}%`,
                              }}
                            />
                          </div>
                          <div className="text-right text-sm text-[#00ff9d] mt-1">
                            {walletScore.socialIntelligence.gmScore.communityEngagement.toFixed(
                              0,
                            )}
                            %
                          </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="text-center">
                        ...
                        <div className="text-2xl font-bold text-white mt-1">
                          {walletScore.socialIntelligence.trustScore.components.inverseRisk.toFixed(
                            1,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-2xl font-bold text-white mt-1">
                          {walletScore.socialIntelligence.trustScore.components.farcasterScore.toFixed(
                            1,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-2xl font-bold text-white mt-1">
                          {walletScore.socialIntelligence.trustScore.components.gmScore.toFixed(
                            1,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-2xl font-bold text-white mt-1">
                          {walletScore.socialIntelligence.trustScore.components.ageBonus.toFixed(
                            1,
                          )}
                        </div>
                    ...
                    <div className="flex justify-between text-white">
                      ...
                      <span className="text-2xl font-bold text-green-400">
                        ...
                        {airdrops
                          ...
                          .reduce(
                            (sum, a) =>
                              sum + parseFloat(a.value.replace("$", "")),
                            0,
                          )
                          .toFixed(2)}
                      </span>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {[
                      ...
                      <div
                        key={protocol}
                        className="metadata-card bg-white/5 rounded-lg p-3 text-center text-white"
                      >
                        {protocol}
                      </div>
                    ))}
