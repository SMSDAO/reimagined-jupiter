    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="bg-white/10 dark:bg-black/30 backdrop-blur-md rounded-xl p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">3. Fees and Payments</h2>
            <div className="text-gray-300 dark:text-gray-200 space-y-3">
              <p>By using GXQ Studio, you agree to the following fee structure:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <p className="mt-4">
                All fees are automatically deducted and sent to the developer wallet: <code className="bg-purple-900/50 px-2 py-1 rounded">monads.solana</code>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              <h3 className="text-yellow-400 font-bold mb-3">⚠️ Important Risk Information</h3>
              <div className="text-gray-300 dark:text-gray-200 space-y-2">
                <p>Cryptocurrency trading carries significant risk:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Trading cryptocurrencies is highly speculative and risky</li>
                ...
                <p className="mt-4 font-bold">
                  Only invest what you can afford to lose. GXQ Studio is not responsible for trading losses.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">5. No Financial Advice</h2>
            <p className="text-gray-300 dark:text-gray-200">
              GXQ Studio does not provide investment, financial, trading, or other advice. All content is provided
              for informational purposes only. You should conduct your own research and consult with qualified
              professionals before making any investment decisions.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">6. Wallet Security</h2>
            <div className="text-gray-300 dark:text-gray-200 space-y-3">
              ...
              <p className="mt-4">
                GXQ Studio never asks for your private keys or seed phrases. Never share this information with anyone.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">8. Affiliate Program</h2>
            <p className="text-gray-300 dark:text-gray-200">
              GXQ Studio offers an affiliate program where participants can earn GXQ tokens. Affiliate terms
              are subject to separate agreements and may be modified at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 dark:text-gray-200">
              GXQ Studio and its developers shall not be liable for any direct, indirect, incidental, special,
              or consequential damages resulting from your use of the Service, including but not limited to
              loss of funds, data, or profits.
            </p>
          </section>
          ...
          <div className="border-t border-purple-500/30 pt-6 mt-8">
            <p className="text-center text-gray-400 text-sm">
              By using GXQ Studio, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
          </div>
        </div>
      </motion.div>
