    ...
    <div className="space-y-12">
        ...
        {features.map((feature, index) => (
          ...
          >
            <Link href={feature.href}>
              <div className={`p-6 rounded-xl bg-gradient-to-br ${feature.color} ${feature.glow} hover:shadow-2xl transition-all cursor-pointer card-3d aura-effect`}>
      ...
      >
        {[
          ...
          { value: '5 Providers', label: 'Flash Loans', color: 'text-blue-400' },
