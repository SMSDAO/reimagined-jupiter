        ...
        if (response.ok) {
          ...
          if (data.opportunities && Array.isArray(data.opportunities)) {
            ...
            if (settings.autoExecute && filteredOpportunities.length > 0) {
              ...
              console.log('[Arbitrage] Auto-executing top opportunity:', topOpp);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {opportunities.length === 0 && scanning && (
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/10 text-center">
                ...
                <p className="text-white text-lg mb-2">Scanning for opportunities...</p>
                <p className="text-gray-400 text-sm">Monitoring 5 flash loan providers and 8+ DEXs</p>
              </div>
            )}
          </div>
        </div>
